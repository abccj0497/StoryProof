...
if __name__ == "__main__":
    ...
    # 시간 관계상 테스트는 앞쪽 5개 덩어리만 진행 (전체 실행 시 parents[:5]를 parents 로 변경)
    ...
    if all_extracted_scenes:
        ...
        print("⚠️ 추출된 씬이 없어 파일을 저장하지 않습니다.")
